...
/* Presentation Encryption Provider Connect Prototype
  ...
  Description:
	...
	call the function till negotiation ends.
...
/* Presentation Encryption Provider Close Function Pointer Prototype
  ...
  Description:
	...
	Networking Presentation Layer after a the connection has been closed by the 
	client.
...
/* Presentation Encryption Provider Write Function Pointer Prototype
  ...
  Description:
	...
	presentation layer when application wishes to write to a secured connection.
...
/* Presentation Encryption Provider Read Function Pointer Prototype
  ...
  Description:
	...
	presentation layer when the presentation Client wishes to read from a secured 
	connection.
  ...
  Parameters:
    providerData - A pointer to the buffer for the provider to keep connection
                   specific data
    buffer	     - This is a pointer to the buffer that will be read from the provider
    count        - This is the size of the buffer
