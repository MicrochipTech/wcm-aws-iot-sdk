...
/* Function:
  ...
  Summary:
    Set the key and initialization vector (IV) for AES processing.
...
/* Function:
  ...
  Summary:
    Set the initialization vector (IV) for AES processing.
...
/* Function:
  ...
  Summary:
	Perform AES encryption using Cipher-Block-Chaining (CBC).
...
/* Function:
  ...
  Summary:
	Perform AES decryption using Cipher-Block-Chaining (CBC).
...
/* Function:
  ...
  Summary:
	Perform AES encryption using Counter (CTR).
...
/* Function:
  ...
  Summary:
	Direct decryption of one block of data.
...
/* Function:
  ...
  Summary:
	Release the memory used for the key and clean up the context.
...
/* Function:
  ...
  Summary:
	Construct the Public Key from a DER certificate.
...
/* Function:
  ...
  Summary:
	Construct the Private Key from a DER certificate.
...
/* Function:
  ...
  Summary:
	Initialize the context for Elliptic Curve Cryptography (ECC).
...
/* Function:
  ...
  Summary:
	Cleanup an Elliptic Curve Cryptography (ECC) Context.
...
/* Function:
  ...
  Summary:
	Import public key in ANSI X9.63 format.
