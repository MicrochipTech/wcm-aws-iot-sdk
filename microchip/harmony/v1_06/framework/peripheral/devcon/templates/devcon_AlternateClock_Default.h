...
PLIB_TEMPLATE void DEVCON_AlternateClockEnable_Default( DEVCON_MODULE_ID index , DEVCON_ALT_CLOCK_TARGET targetAltClock )
{
    switch ( targetAltClock )
    {
        case DEVCON_ALT_CLOCK_IC:
            _SFR_BIT_SET(_DEVCON_IC_ALT_CLOCK_SELECT_VREG(index),_DEVCON_IC_ALT_CLOCK_SELECT_POS(index));
            break;
        case DEVCON_ALT_CLOCK_OC:
            _SFR_BIT_SET(_DEVCON_OC_ALT_CLOCK_SELECT_VREG(index),_DEVCON_OC_ALT_CLOCK_SELECT_POS(index));
            break;
        default:
...
PLIB_TEMPLATE void DEVCON_AlternateClockDisable_Default( DEVCON_MODULE_ID index , DEVCON_ALT_CLOCK_TARGET targetAltClock )
{
    ...
    {
        case DEVCON_ALT_CLOCK_IC:
            _SFR_BIT_CLEAR(_DEVCON_IC_ALT_CLOCK_SELECT_VREG(index),_DEVCON_IC_ALT_CLOCK_SELECT_POS(index));
            break;
        case DEVCON_ALT_CLOCK_OC:
            _SFR_BIT_CLEAR(_DEVCON_OC_ALT_CLOCK_SELECT_VREG(index),_DEVCON_OC_ALT_CLOCK_SELECT_POS(index));
            break;
        default:
            PLIB_ASSERT(false,"Unknown targetAltClock!");
            break;
