...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _POWER_VOLTAGE_REGULATOR_CONTROL_VREG(index)

  MASKs: 
    _POWER_VOLTAGE_REGULATOR_CONTROL_MASK(index)

  POSs: 
    _POWER_VOLTAGE_REGULATOR_CONTROL_POS(index)

  LENs: 
    _POWER_VOLTAGE_REGULATOR_CONTROL_LEN(index)
...
{
   _SFR_BIT_SET(_POWER_VOLTAGE_REGULATOR_CONTROL_VREG(index),_POWER_VOLTAGE_REGULATOR_CONTROL_POS(index));
}
...
{
     _SFR_BIT_CLEAR(_POWER_VOLTAGE_REGULATOR_CONTROL_VREG(index),_POWER_VOLTAGE_REGULATOR_CONTROL_POS(index));
}
...
{
    return _SFR_BIT_READ(_POWER_VOLTAGE_REGULATOR_CONTROL_VREG(index),_POWER_VOLTAGE_REGULATOR_CONTROL_POS(index));
}
