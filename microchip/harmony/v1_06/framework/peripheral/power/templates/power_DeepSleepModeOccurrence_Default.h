...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _POWER_DEEP_SLEEP_MODE_STATUS_VREG(index)

  MASKs: 
    _POWER_DEEP_SLEEP_MODE_STATUS_MASK(index)

  POSs: 
    _POWER_DEEP_SLEEP_MODE_STATUS_POS(index)

  LENs: 
    _POWER_DEEP_SLEEP_MODE_STATUS_LEN(index)
...
{
   	return (bool)(_SFR_BIT_READ(_POWER_DEEP_SLEEP_MODE_STATUS_VREG(index), _POWER_DEEP_SLEEP_MODE_STATUS_POS(index)));
}
...
{
     _SFR_BIT_CLEAR(_POWER_DEEP_SLEEP_MODE_STATUS_VREG(index),_POWER_DEEP_SLEEP_MODE_STATUS_POS(index));
}
