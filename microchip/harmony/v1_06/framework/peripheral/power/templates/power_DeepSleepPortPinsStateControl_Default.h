...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _POWER_DEEP_SLEEP_IO_STATES_CONTROL_VREG(index)

  MASKs: 
    _POWER_DEEP_SLEEP_IO_STATES_CONTROL_MASK(index)

  POSs: 
    _POWER_DEEP_SLEEP_IO_STATES_CONTROL_POS(index)

  LENs: 
    _POWER_DEEP_SLEEP_IO_STATES_CONTROL_LEN(index)
...
{
   _SFR_BIT_SET(_POWER_DEEP_SLEEP_IO_STATES_CONTROL_VREG(index),_POWER_DEEP_SLEEP_IO_STATES_CONTROL_POS(index));
}
...
{
   _SFR_BIT_CLEAR(_POWER_DEEP_SLEEP_IO_STATES_CONTROL_VREG(index),_POWER_DEEP_SLEEP_IO_STATES_CONTROL_POS(index));
}
