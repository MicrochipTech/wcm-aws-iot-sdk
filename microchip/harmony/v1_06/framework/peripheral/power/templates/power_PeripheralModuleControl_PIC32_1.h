...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _POWER_ADC1_CONTROL_VREG(index)
    _POWER_REF_CLK_OUTPUT_CONTROL_VREG(index)

  MASKs: 
    _POWER_ADC1_CONTROL_MASK(index)
    _POWER_REF_CLK_OUTPUT_CONTROL_MASK(index)

  POSs: 
    _POWER_ADC1_CONTROL_POS(index)
    _POWER_REF_CLK_OUTPUT_CONTROL_POS(index)

  LENs: 
    _POWER_ADC1_CONTROL_LEN(index)
    _POWER_REF_CLK_OUTPUT_CONTROL_LEN(index)
