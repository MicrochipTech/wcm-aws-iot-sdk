...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADC_VOLTAGE_REFERENCE_VREG(index)

  MASKs: 
    _ADC_VOLTAGE_REFERENCE_MASK(index)

  POSs: 
    _ADC_VOLTAGE_REFERENCE_POS(index)

  LENs: 
    _ADC_VOLTAGE_REFERENCE_LEN(index)
...
{
     _SFR_FIELD_WRITE(_ADC_VOLTAGE_REFERENCE_VREG(index),
                        _ADC_VOLTAGE_REFERENCE_MASK(index),
                        _ADC_VOLTAGE_REFERENCE_POS(index) ,
                        configValue );
}
