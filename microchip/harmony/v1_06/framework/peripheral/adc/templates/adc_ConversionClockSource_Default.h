...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADC_CONVERSION_CLOCK_SOURCE_VREG(index)

  MASKs: 
    _ADC_CONVERSION_CLOCK_SOURCE_MASK(index)

  POSs: 
    _ADC_CONVERSION_CLOCK_SOURCE_POS(index)

  LENs: 
    _ADC_CONVERSION_CLOCK_SOURCE_LEN(index)
...
{
    _SFR_FIELD_WRITE(_ADC_CONVERSION_CLOCK_SOURCE_VREG(index),
                        _ADC_CONVERSION_CLOCK_SOURCE_MASK(index),
                        _ADC_CONVERSION_CLOCK_SOURCE_POS(index) ,
                        source );
}
