...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADC_RESULT_BUFFER_MODE_VREG(index)

  MASKs: 
    _ADC_RESULT_BUFFER_MODE_MASK(index)

  POSs: 
    _ADC_RESULT_BUFFER_MODE_POS(index)

  LENs: 
    _ADC_RESULT_BUFFER_MODE_LEN(index)
...
{
    _SFR_FIELD_WRITE(_ADC_RESULT_BUFFER_MODE_VREG(index),
                        _ADC_RESULT_BUFFER_MODE_MASK(index),
                        _ADC_RESULT_BUFFER_MODE_POS(index) ,
                        mode );
}
