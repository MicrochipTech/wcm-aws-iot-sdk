...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADC_CONVERSION_STATUS_VREG(index)

  MASKs: 
    _ADC_CONVERSION_STATUS_MASK(index)

  POSs: 
    _ADC_CONVERSION_STATUS_POS(index)

  LENs: 
    _ADC_CONVERSION_STATUS_LEN(index)
...
{
    return _SFR_BIT_READ(_ADC_CONVERSION_STATUS_VREG(index),
                             _ADC_CONVERSION_STATUS_POS(index) );
}
