...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _ADC_MUX_INPUT_SCAN_SELECT_EXTENDED_VREG(index)

  MASKs: 
    _ADC_MUX_INPUT_SCAN_SELECT_EXTENDED_MASK(index)

  POSs: 
    _ADC_MUX_INPUT_SCAN_SELECT_EXTENDED_POS(index)

  LENs: 
    _ADC_MUX_INPUT_SCAN_SELECT_EXTENDED_LEN(index)
...
{
    _SFR_SET(_ADC_MUX_INPUT_SCAN_SELECT_EXTENDED_VREG(index), scanInputs);
}
...
{
    _SFR_CLEAR(_ADC_MUX_INPUT_SCAN_SELECT_EXTENDED_VREG(index), scanInputs);
}
