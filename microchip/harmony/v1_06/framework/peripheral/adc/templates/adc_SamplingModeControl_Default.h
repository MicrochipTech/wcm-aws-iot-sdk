...
/* Routines available for accessing VREGS, MASKS, POS, LEN are
  ...
  VREGs:
    _ADC_SAMPLING_MODE_CONTROL_VREG(index)

  MASKs:
    _ADC_SAMPLING_MODE_CONTROL_MASK(index)

  POSs:
    _ADC_SAMPLING_MODE_CONTROL_POS(index)

  LENs:
    _ADC_SAMPLING_MODE_CONTROL_LEN(index)
...
{
    _SFR_BIT_WRITE(_ADC_SAMPLING_MODE_CONTROL_VREG(index),
					_ADC_SAMPLING_MODE_CONTROL_POS(index) ,
					mode  );
}
