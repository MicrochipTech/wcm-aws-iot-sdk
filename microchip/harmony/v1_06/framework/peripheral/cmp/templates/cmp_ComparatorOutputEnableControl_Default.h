...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _CMP_CMP_OUTPUT_ENABLE_CONTROL_VREG(index)

  MASKs: 
    _CMP_CMP_OUTPUT_ENABLE_CONTROL_MASK(index)

  POSs: 
    _CMP_CMP_OUTPUT_ENABLE_CONTROL_POS(index)

  LENs: 
    _CMP_CMP_OUTPUT_ENABLE_CONTROL_LEN(index)
...
{
    _SFR_BIT_SET(_CMP_CMP_OUTPUT_ENABLE_CONTROL_VREG(index), _CMP_CMP_OUTPUT_ENABLE_CONTROL_POS(index));
}
...
{
    _SFR_BIT_CLEAR(_CMP_CMP_OUTPUT_ENABLE_CONTROL_VREG(index), _CMP_CMP_OUTPUT_ENABLE_CONTROL_POS(index));
}
