...
/* Function:
  ...
  Summary:
    This function provides the status of the Flash write cycle.	  
...
/* Function:
  ...
  Summary:
    This function provides the status of the Flash write operation
    or sequence.	  
...
/* Function:
  ...
  Description:
    This function allows changing the write control (WR) bit and it disables
...
/* Function:
  ...
  Description:
    This function disables the writing in the write control (WR) bit and it
    enables writing into the SWAP and NVMOP bits.
...
/* Function:
  ...
  Summary:
    This function provides the availability status of the EEPROM.	  
...
/* Function:
  ...
  Description:
    This function initiates the EERPOM read cycle.
...
/* Function:
  ...
  Summary:
    This function provides the status of the EEPROM write or erase or read cycle.	  
...
/* Function:
  ...
  Summary:
    Aborts current EEPROM operation.		  

  Description:
    This function abort the on-going write or erase operation as soon as possible.
