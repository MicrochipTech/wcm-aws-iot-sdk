...
PLIB_TEMPLATE uint8_t DMA_ChannelXPatternDataGet_Default( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel )
{
...
PLIB_TEMPLATE void DMA_ChannelXPatternDataSet_Default( DMA_MODULE_ID index , DMA_CHANNEL dmaChannel , uint8_t patternData )
{
    SFR_TYPE *pDmaChanXControlReg;
