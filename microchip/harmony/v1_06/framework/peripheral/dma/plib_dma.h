...
//******************************************************************************
/* Function:
    DMA_CHANNEL PLIB_DMA_LastChannelActive ( DMA_MODULE_ID index )

  Summary:
    Returns the last DMA channel that participated in the data transfer.

  Description:
    This function returns the last DMA channel that participated in the data transfer.
  ...
  Example:
    <code>
	DMA_CHANNEL lastActiveChannel;
    lastActiveChannel = PLIB_DMA_LastChannelActive( DMA_ID_0 );
    </code>
...
/* Function:
  ...
  Example:
    ...
    ChAutoEnableStatus = PLIB_DMA_ChannelXAutoIsEnabled(DMA_ID_0,
                                                        DMA_CHANNEL_2 );
    </code>
...
/* Function:
  ...
  Description:
    This function will chain the specified channel to a channel lower in natural priority.
	CH3 will be enabled by a CH4 transfer complete.
...
/* Function:
  ...
  Description:
    This function will Chain the specified channel to a channel higher in natural priority.
	CH5 will be enabled by a CH4 transfer complete.
...
/* Function:
  ...
  Description:
    This function sets the busy bit to active, indicating the channel is active or has
	been enabled.
...
/* Function:
  ...
  Description:
    This function sets the busy bit to inactive, indicating the channel is inactive or has
	been disabled.
...
/* Function:
  ...
  Parameters:
	channel			- One of the possible DMA channels listed by DMA_CHANNEL
	chTransferDirection	- The transfer direction indicated by the DMA_CHANNEL_TRANSFER_DIRECTION
...
/* Function:
  ...
  Description:
    This function enables reloading of the address and count registers. The source, destination
	address, and the DMA count registers are reloaded to their previous values upon the
...
/* Function:
  ...
  Description:
    This function enables the DMA module CRC feature. The channel transfers are routed
	through the CRC.
...
/* Function:
  ...
  Parameters:
	...
	destinationSize	- The destination size
        (The destination size (8-bit, 16-bit) is device-specific. Please refer to the
...
/* Function:
  ...
  Parameters:
    dmaChannel	- One of the possible DMA channels listed by DMA_CHANNEL
    cellSize	- The cell size in bytes
    (The cell size (8-bit, 16-bit) is device-specific. Please refer to the specific
    device data sheet to determine availability.)
...
/* Function:
  ...
  Returns:
    ...
    (The cell progress pointer (8-bit, 16-bit) is device-specific. Please refer to the specific
    device data sheet to determine availability.)
...
/* Function :  PLIB_DMA_ExistsBusy( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the Busy feature is available on the DMA module.
...
/* Function :  PLIB_DMA_ExistsSuspend( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the Suspend feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsStopInIdle( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the StopInIdle feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsEnableControl( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the EnableControl feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
    - PLIB_DMA_Enable
    - PLIB_DMA_Disable
    - PLIB_DMA_IsEnabled
...
/* Function :  PLIB_DMA_ExistsChannelBits( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelBits feature is available on the DMA module.
...
/* Function :  PLIB_DMA_ExistsLastBusAccess( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the LastBusAccess feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsRecentAddress( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the RecentAddress feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCChannel( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCChannel feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCType( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCType feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
    - PLIB_DMA_CRCTypeGet
    - PLIB_DMA_CRCTypeSet
...
/* Function :  PLIB_DMA_ExistsCRCAppendMode( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCAppendMode feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCPolynomialLength( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCPolynomialLength feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCBitOrder( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCBitOrder feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCWriteByteOrder( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCWriteByteOrder feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCByteOrder( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCByteOrder feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCData( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCData feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsCRCXOREnable( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the CRCXOREnable feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXPriority( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXPriority feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXEvent( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXEvent feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXAuto( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXAuto feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXChainEnbl( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXChainEnbl feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXDisabled( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXDisabled feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelX( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelX feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXChain( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXChain feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXPatternLength( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXPatternLength feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXPatternIgnoreByte( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXPatternIgnoreByte feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXBusy( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXBusy feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXPatternIgnore( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXPatternIgnore feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXTrigger( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXTrigger feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsAbortTransfer( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the AbortTransfer feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsStartTransfer( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the StartTransfer feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXStartIRQ( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXStartIRQ feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXAbortIRQ( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXAbortIRQ feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXINTSourceFlag( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXINTSourceFlag feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXINTSource( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXINTSource feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXSourceStartAddress( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXSourceStartAddress feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXDestinationStartAddress( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXDestinationStartAddress feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXSourceSize( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXSourceSize feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXDestinationSize( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXDestinationSize feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXSourcePointer( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXSourcePointer feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXDestinationPointer( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXDestinationPointer feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXCellSize( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXCellSize feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXCellProgressPointer( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXCellProgressPointer feature is available on the DMA module.
    When this function returns true, this function is supported on the device:
...
/* Function :  PLIB_DMA_ExistsChannelXPatternData( DMA_MODULE_ID index )
  ...
  Description:
    This function identifies whether the ChannelXPatternData feature is available on the DMA module.
    When this function returns true, these functions are supported on the device:
