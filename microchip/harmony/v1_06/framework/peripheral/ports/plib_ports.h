...
/* Function:
  ...
  Remarks:
    This API is only available in devices with PPS. For Non-PPS devices, use
...
/* Function:
  ...
  Description:
    ...
    This API should be used to read the live data at the pin.
  ...
  Remarks:
    For reading the Latched data, PLIB_PORTS_PinGetLatched API should be used.
...
/* Function:
  ...
  Remarks:
    For reading the Live data from the i/o pin, PLIB_PORTS_PinGet API
    should be used.
...
/* Function:
  ...
  Description:
    This function reads/gets data from the selected Latch.
  ...
  Remarks:
    For reading the Live data, PLIB_PORTS_Read API should be used.
...
/* Function:
  ...
  Remarks:
    For reading the Latched data, PLIB_PORTS_ReadLatched API should be used.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    channel         - Port pin channel
    modeMask        - Identifies the pins which mode has to be modified.
                      Modes of the pins which corresponding bit is "1" get
  ...
  Remarks:
    This API is only available in devices with PPS. For Non-PPS devices, use
    PLIB_PORTS_AnPinsModeSelect API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    channel         - Port pin channel
    mask            - Identifies the pins for which pull up has to be enabled 
  ...
  Remarks:
    This API is only available in devices with PPS. For Non-PPS devices, use
    PLIB_PORTS_CnPinsPullUpEnable API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    channel         - Port pin channel
    mask            - Identifies the pins for which pull up has to be Disabled 
  ...
  Remarks:
    This API is only available in devices with PPS. For Non-PPS devices, use
    PLIB_PORTS_CnPinsPullUpDisable API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    channel         - Port pin channel
    mask            - Identifies the pins for which pull Down has to be enabled 
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    channel         - Port pin channel
    mask            - Identifies the pins for which pull Down has to be Disabled 
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    channel         - Port pin channel
    mask            - Identifies the pins for which change notification has
                      to be enabled 
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    anPins          - AN pins which mode has to be changed. Multiple AN pins
                      can be ORed. 
    mode            - Possible values of PORTS_PIN_MODE (Analog or Digital)
  ...
  Example:
    ...
    PLIB_PORTS_AnPinsModeSelect(PORTS_ID_0, PORTS_AN_PIN_5 | PORTS_AN_PIN_8 | PORTS_AN_PIN_13, PORTS_PIN_MODE_ANALOG);
                                                                
    </code>

  Remarks:
    This API is only available in devices without PPS feature. For PPS
    devices, use PLIB_PORTS_ChannelModeSelect API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    cnPins          - CN pins which pull-up has to be enabled. Multiple CN pins
                      can be ORed.
  ...
  Example:
    ...
    PLIB_PORTS_CnPinsPullUpEnable(PORTS_ID_0, CHANGE_NOTICE_PIN_5 | CHANGE_NOTICE_PIN_8 | CHANGE_NOTICE_PIN_13);
    
    </code>

  Remarks:
    This API is only available in devices without PPS feature. For PPS
    devices, use PLIB_PORTS_ChannelChangeNoticePullUpEnable API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    cnPins          - CN pins which pull-up has to be disabled. Multiple CN pins
                      can be ORed.
  ...
  Example:
    ...
    PLIB_PORTS_CnPinsPullUpDisable(PORTS_ID_0, CHANGE_NOTICE_PIN_5 | CHANGE_NOTICE_PIN_8 | CHANGE_NOTICE_PIN_13);
    
    </code>

  Remarks:
    This API is only available in devices without PPS feature. For PPS
    devices, use PLIB_PORTS_ChannelChangeNoticePullUpDisable API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    cnPins          - CN pins which has to be enabled. Multiple CN pins
                      can be ORed.
  ...
  Example:
    ...
    PLIB_PORTS_CnPinsEnable(PORTS_ID_0, CHANGE_NOTICE_PIN_5 | CHANGE_NOTICE_PIN_8 | CHANGE_NOTICE_PIN_13);
    
    </code>

  Remarks:
    This API is only available in devices without PPS feature. For PPS
    devices, use PLIB_PORTS_ChannelChangeNoticeEnable API.
...
/* Function:
  ...
  Parameters:
    index           - Identifier for the device instance to be configured
    cnPins          - CN pins which has to be disabled. Multiple CN pins
                      can be ORed.
  ...
  Example:
    ...
    PLIB_PORTS_CnPinsDisable(PORTS_ID_0, CHANGE_NOTICE_PIN_5 | CHANGE_NOTICE_PIN_8 | CHANGE_NOTICE_PIN_13);
    
    </code>

  Remarks:
    This API is only available in devices without PPS feature. For PPS
    devices, use PLIB_PORTS_ChannelChangeNoticeDisable API.
...
/* Function:
  ...
  Remarks:
    This API is only available in devices without PPS. For PPS devices, use
...
/* Function:
  ...
  Example:
    ...
    PLIB_PORTS_ChannelSlewRateSelect(PORTS_ID_0, PORT_CHANNEL_C, 0x2120, PORTS_PIN_SLEW_RATE_SLOWEST);
...
/* Function:
  ...
  Summary:
    Gets the change notice style for selected port channel.

  Description:
    This function gets the change notice style (or method) for selected port
    channel.
...
/* Function:
  ...
  Precondition:
    ...
    PLIB_PORTS_ChannelChangeNoticeMethodSelect API before using this API.
...
/* Function:
  ...
  Description:
    This function checks if change notice edge transition has occurred or not
  ...
  Example:
    <code>
    // Check if change notice edge transition has occurred or not for pin RC1.
...
//******************************************************************************
/* Function :  PLIB_PORTS_ExistsAnPinsMode( PORTS_MODULE_ID index )

  Summary:
    Identifies whether the AnPinsMode feature exists on the PORTS module 

  Description:
    This function identifies whether the AnPinsMode feature is available on the PORTS module.
    When this function returns true, this function is supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_PORTS_ExistsLatchRead( PORTS_MODULE_ID index )

  Summary:
    Identifies whether the LatchRead feature exists on the PORTS module 

  Description:
    This function identifies whether the LatchRead feature is available on the PORTS module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_PORTS_ExistsSlewRateControl( PORTS_MODULE_ID index )

  Summary:
    Identifies whether the SlewRateControl feature exists on the PORTS module 

  Description:
    This function identifies whether the SlewRateControl feature is available on the PORTS module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_PORTS_ExistsChannelChangeNoticeMethod( PORTS_MODULE_ID index )

  Summary:
    Identifies whether the ChannelChangeNoticeMethod feature exists on the PORTS module 

  Description:
    This function identifies whether the ChannelChangeNoticeMethod feature is available on the PORTS module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_PORTS_ExistsChangeNoticeEdgeControl( PORTS_MODULE_ID index )

  Summary:
    Identifies whether the ChangeNoticeEdgeControl feature exists on the PORTS module 

  Description:
    This function identifies whether the ChangeNoticeEdgeControl feature is available on the PORTS module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_PORTS_ExistsChangeNoticeEdgeStatus( PORTS_MODULE_ID index )

  Summary:
    Identifies whether the ChangeNoticeEdgeStatus feature exists on the PORTS module 

  Description:
    This function identifies whether the ChangeNoticeEdgeStatus feature is available on the PORTS module.
    When this function returns true, these functions are supported on the device: 
