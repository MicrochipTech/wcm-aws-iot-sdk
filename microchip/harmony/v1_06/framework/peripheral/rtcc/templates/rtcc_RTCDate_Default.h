...
{
    return _SFR_READ( _RTCC_RTCDATE_VREG( index ) );
}
...
{
    _SFR_WRITE( _RTCC_RTCDATE_VREG( index ), data );
}
...
{
    return _SFR_FIELD_READ( _RTCC_DATE_YEAR10_VREG( index ),
	                        _RTCC_DATE_YEAR10_MASK( index ) | _RTCC_DATE_YEAR01_MASK( index ),
							_RTCC_DATE_YEAR01_POS( index ) );
...
{
    _SFR_FIELD_WRITE( _RTCC_DATE_YEAR10_VREG( index ),
	                  _RTCC_DATE_YEAR10_MASK( index ) | _RTCC_DATE_YEAR01_MASK( index ),
					  _RTCC_DATE_YEAR01_POS( index ),
					  year );
}
...
{
    return _SFR_FIELD_READ( _RTCC_DATE_MONTH10_VREG( index ),
	                        _RTCC_DATE_MONTH10_MASK( index ) | _RTCC_DATE_MONTH01_MASK( index ),
							_RTCC_DATE_MONTH01_POS( index ) );
}
...
{
    _SFR_FIELD_WRITE( _RTCC_DATE_MONTH10_VREG( index ),
	                  _RTCC_DATE_MONTH10_MASK( index ) | _RTCC_DATE_MONTH01_MASK( index ),
					  _RTCC_DATE_MONTH01_POS( index ),
					  month );
}
...
{
    return _SFR_FIELD_READ( _RTCC_DATE_DAY10_VREG( index ),
	                        _RTCC_DATE_DAY10_MASK( index ) | _RTCC_DATE_DAY01_MASK( index ),
							_RTCC_DATE_DAY01_POS( index ) );
}
...
{
    _SFR_FIELD_WRITE( _RTCC_DATE_DAY10_VREG( index ),
	                  _RTCC_DATE_DAY10_MASK( index ) | _RTCC_DATE_DAY01_MASK( index ),
					  _RTCC_DATE_DAY01_POS( index ),
					  day );
}
...
{
    return _SFR_FIELD_READ( _RTCC_DATE_WDAY01_VREG( index ),
	                        _RTCC_DATE_WDAY01_MASK( index ),
							_RTCC_DATE_WDAY01_POS( index ) );
}
...
{
    _SFR_FIELD_WRITE( _RTCC_DATE_WDAY01_VREG( index ),
	                  _RTCC_DATE_WDAY01_MASK( index ),
					  _RTCC_DATE_WDAY01_POS( index ),
					  weekday );
}
