...
{
    return _SFR_READ( _RTCC_RTCTIME_VREG( index ) );
}
...
{
    _SFR_WRITE( _RTCC_RTCTIME_VREG( index ), data );
}
...
{
    return _SFR_FIELD_READ( _RTCC_TIME_HR10_VREG( index ),
	                        _RTCC_TIME_HR10_MASK( index ) | _RTCC_TIME_HR01_MASK( index ),
							_RTCC_TIME_HR01_POS( index ) );
}
...
{
    _SFR_FIELD_WRITE( _RTCC_TIME_HR10_VREG( index ),
	                  _RTCC_TIME_HR10_MASK( index ) | _RTCC_TIME_HR01_MASK( index ),
					  _RTCC_TIME_HR01_POS( index ),
					  hour );
}
...
{
    return _SFR_FIELD_READ( _RTCC_TIME_MIN10_VREG( index ),
	                        _RTCC_TIME_MIN10_MASK( index ) | _RTCC_TIME_MIN01_MASK( index ),
							_RTCC_TIME_MIN01_POS( index ) );
}
...
{
    _SFR_FIELD_WRITE( _RTCC_TIME_MIN10_VREG( index ),
	                  _RTCC_TIME_MIN10_MASK( index ) | _RTCC_TIME_MIN01_MASK( index ),
					  _RTCC_TIME_MIN01_POS( index ),
					  minute );
}
...
{
    return _SFR_FIELD_READ( _RTCC_TIME_SEC10_VREG( index ),
	                        _RTCC_TIME_SEC10_MASK( index ) | _RTCC_TIME_SEC01_MASK( index ),
							_RTCC_TIME_SEC01_POS( index ) );
}
...
{
    _SFR_FIELD_WRITE( _RTCC_TIME_SEC10_VREG( index ),
	                  _RTCC_TIME_SEC10_MASK( index ) | _RTCC_TIME_SEC01_MASK( index ),
					  _RTCC_TIME_SEC01_POS( index ),
					  second );
}
