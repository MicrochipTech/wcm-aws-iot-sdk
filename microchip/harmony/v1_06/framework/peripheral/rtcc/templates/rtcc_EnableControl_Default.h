...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _RTCC_ENABLE_CONTROL_VREG(index)

  MASKs: 
    _RTCC_ENABLE_CONTROL_MASK(index)

  POSs: 
    _RTCC_ENABLE_CONTROL_POS(index)

  LENs: 
    _RTCC_ENABLE_CONTROL_LEN(index)
...
{
    _SFR_BIT_SET( _RTCC_ENABLE_CONTROL_VREG( index ),
				  _RTCC_ENABLE_CONTROL_POS( index ) );
}
...
{
    _SFR_BIT_CLEAR( _RTCC_ENABLE_CONTROL_VREG( index ),
				    _RTCC_ENABLE_CONTROL_POS( index ) );
}
