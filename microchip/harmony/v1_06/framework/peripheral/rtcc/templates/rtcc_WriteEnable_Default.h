...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _RTCC_WRITE_ENABLE_VREG(index)

  MASKs: 
    _RTCC_WRITE_ENABLE_MASK(index)

  POSs: 
    _RTCC_WRITE_ENABLE_POS(index)

  LENs: 
    _RTCC_WRITE_ENABLE_LEN(index)
...
{
    _SFR_BIT_SET( _RTCC_WRITE_ENABLE_VREG( index ),
				  _RTCC_WRITE_ENABLE_POS( index ) );
}
...
{
    _SFR_BIT_CLEAR( _RTCC_WRITE_ENABLE_VREG( index ),
				    _RTCC_WRITE_ENABLE_POS( index ) );
}
