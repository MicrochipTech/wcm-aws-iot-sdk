...
/* Routines available for accessing VREGS, MASKS, POS, LEN are 
  ...
  VREGs: 
    _RTCC_HALFSEC_STATUS_VREG(index)

  MASKs: 
    _RTCC_HALFSEC_STATUS_MASK(index)

  POSs: 
    _RTCC_HALFSEC_STATUS_POS(index)

  LENs: 
    _RTCC_HALFSEC_STATUS_LEN(index)
...
{
    return _SFR_BIT_READ( _RTCC_HALFSEC_STATUS_VREG( index ), 
	                      _RTCC_HALFSEC_STATUS_POS( index ) );
}
