...
/* Function:
  ...
  Returns:
    Status          - SPI receiver overflow status
...
/* Function:
  ...
  Returns:
    Status          - Receiver Buffer Full Status
...
/* Function:
  ...
  Precondition:
    SPI 16-bit wide communication must selected. Use 
	PLIB_SPI_CommunicationWidthSelect API.
...
/* Function:
  ...
  Precondition:
    SPI 32-bit wide communication must selected. Use 
	PLIB_SPI_CommunicationWidthSelect API.
...
/* Function :  PLIB_SPI_BufferAddressGet( SPI_MODULE_ID index )
  ...
  Returns:
    -void * - Returns the address of the SPIxBUF register
...
// *****************************************************************************
// *****************************************************************************
// Section: SPI Peripheral Library Exists API Routines
// *****************************************************************************
// *****************************************************************************
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsEnableControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the EnableControl feature exists on the SPI module 

  Description:
    This function identifies whether the EnableControl feature is available on the SPI module.
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsStopInIdleControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the StopInIdle feature exists on the SPI module 

  Description:
    This function identifies whether the StopInIdle feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsReceiverOverflow( SPI_MODULE_ID index )

  Summary:
    Identifies whether the ReceiverOverflow feature exists on the SPI module 

  Description:
    This function identifies whether the ReceiverOverflow feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsTransmitBufferFullStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the TransmitBufferFullStatus feature exists on the SPI module 

  Description:
    This function identifies whether the TransmitBufferFullStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsTransmitBufferEmptyStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the TransmitBufferEmptyStatus feature exists on the SPI module 

  Description:
    This function identifies whether the TransmitBufferEmptyStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsReceiveBufferStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the ReceiveBufferStatus feature exists on the SPI module 

  Description:
    This function identifies whether the ReceiveBufferStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsPinControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the PinControl feature exists on the SPI module 

  Description:
    This function identifies whether the PinControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
    - PLIB_SPI_PinEnable
    - PLIB_SPI_PinDisable
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsCommunicationWidth( SPI_MODULE_ID index )

  Summary:
    Identifies whether the CommunicationWidth feature exists on the SPI module 

  Description:
    This function identifies whether the CommunicationWidth feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsAudioCommunicationWidth( SPI_MODULE_ID index )

  Summary:
    Identifies whether the AudioCommunicationWidth feature exists on the SPI module 

  Description:
    This function identifies whether the AudioCommunicationWidth feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsInputSamplePhase( SPI_MODULE_ID index )

  Summary:
    Identifies whether the InputSamplePhase feature exists on the SPI module 

  Description:
    This function identifies whether the InputSamplePhase feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsOutputDataPhase( SPI_MODULE_ID index )

  Summary:
    Identifies whether the OutputDataPhase feature exists on the SPI module 

  Description:
    This function identifies whether the OutputDataPhase feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsClockPolarity( SPI_MODULE_ID index )

  Summary:
    Identifies whether the ClockPolarity feature exists on the SPI module 

  Description:
    This function identifies whether the ClockPolarity feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsMasterControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the MasterControl feature exists on the SPI module 

  Description:
    This function identifies whether the MasterControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsBaudRate( SPI_MODULE_ID index )

  Summary:
    Identifies whether the BaudRate feature exists on the SPI module 

  Description:
    This function identifies whether the BaudRate feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsBusStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the BusStatus feature exists on the SPI module 

  Description:
    This function identifies whether the BusStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
    - PLIB_SPI_IsBusy
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsReadDataSignStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the ReadDataSignStatus feature exists on the SPI module 

  Description:
    This function identifies whether the ReadDataSignStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsSlaveSelectControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the SlaveSelectControl feature exists on the SPI module 

  Description:
    This function identifies whether the SlaveSelectControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsTransmitUnderRunStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the TransmitUnderRunStatus feature exists on the SPI module 

  Description:
    This function identifies whether the TransmitUnderRunStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFIFOControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FIFOControl feature exists on the SPI module 

  Description:
    This function identifies whether the FIFOControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
    - PLIB_SPI_FIFOEnable
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFIFOCount( SPI_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsReceiveFIFOStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the ReceiveFIFOStatus feature exists on the SPI module 

  Description:
    This function identifies whether the ReceiveFIFOStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFIFOShiftRegisterEmptyStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FIFOShiftRegisterEmptyStatus feature exists on the SPI module 

  Description:
    This function identifies whether the FIFOShiftRegisterEmptyStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFIFOInterruptMode( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FIFOInterruptMode feature exists on the SPI module 

  Description:
    This function identifies whether the FIFOInterruptMode feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFramedCommunication( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FramedCommunication feature exists on the SPI module 

  Description:
    This function identifies whether the FramedCommunication feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFrameSyncPulseDirection( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FrameSyncPulseDirection feature exists on the SPI module 

  Description:
    This function identifies whether the FrameSyncPulseDirection feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFrameSyncPulsePolarity( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FrameSyncPulsePolarity feature exists on the SPI module 

  Description:
    This function identifies whether the FrameSyncPulsePolarity feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFrameSyncPulseEdge( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FrameSyncPulseEdge feature exists on the SPI module 

  Description:
    This function identifies whether the FrameSyncPulseEdge feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFrameSyncPulseWidth( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FrameSyncPulseWidth feature exists on the SPI module 

  Description:
    This function identifies whether the FrameSyncPulseWidth feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFrameSyncPulseCounter( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FrameSyncPulseCounter feature exists on the SPI module 

  Description:
    This function identifies whether the FrameSyncPulseCounter feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsFrameErrorStatus( SPI_MODULE_ID index )

  Summary:
    Identifies whether the FrameErrorStatus feature exists on the SPI module 

  Description:
    This function identifies whether the FrameErrorStatus feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsBuffer( SPI_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsBaudRateClock( SPI_MODULE_ID index )

  Summary:
    Identifies whether the BaudRateClock feature exists on the SPI module 

  Description:
    This function identifies whether the BaudRateClock feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsErrorInterruptControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the ErrorInterruptControl feature exists on the SPI module 

  Description:
    This function identifies whether the ErrorInterruptControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsAudioErrorControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the AudioErrorControl feature exists on the SPI module 

  Description:
    This function identifies whether the AudioErrorControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsAudioProtocolControl( SPI_MODULE_ID index )

  Summary:
    Identifies whether the AudioProtocolControl feature exists on the SPI module 

  Description:
    This function identifies whether the AudioProtocolControl feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsAudioTransmitMode( SPI_MODULE_ID index )

  Summary:
    Identifies whether the AudioTransmitMode feature exists on the SPI module 

  Description:
    This function identifies whether the AudioTransmitMode feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_ExistsAudioProtocolMode( SPI_MODULE_ID index )

  Summary:
    Identifies whether the AudioProtocolMode feature exists on the SPI module 

  Description:
    This function identifies whether the AudioProtocolMode feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
    - PLIB_SPI_AudioProtocolModeSelect
...
//******************************************************************************
/* Function :  PLIB_SPI_Exists32bitBuffer( SPI_MODULE_ID index )

  Summary:
    Identifies whether the Buffer32bit feature exists on the SPI module 

  Description:
    This function identifies whether the Buffer32bit feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
...
//******************************************************************************
/* Function :  PLIB_SPI_Exists16bitBuffer( SPI_MODULE_ID index )

  Summary:
    Identifies whether the Buffer16bit feature exists on the SPI module 

  Description:
    This function identifies whether the Buffer16bit feature is available on the SPI module.
    When this function returns true, these functions are supported on the device: 
