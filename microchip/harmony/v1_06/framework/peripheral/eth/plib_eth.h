...
/* Function:
  ...
  Precondition:
     Write to the Pause Timer register before enabling the receiver.
     Call this function before calling PLIB_ETH_ReceiveEnable()
...
/* Function:
  ...
  Description:
    ...
    and packet(s) defined in the Ethernet descriptor table are transmitted.
...
/* Function:
  ...
  Summary:
    Sets the Ethernet module receive full water mark.

  Description:
    This function sets the Ethernet receive full water mark with a new value.
...
/* Function:
  ...
  Summary:
    Gets the Ethernet module receive full watermark.

  Description:
    This function gets the Ethernet receive full watermark.
...
/* Function:
  ...
  Parameters:
    index - Identifier for the device instance
    backToBackIPGValue - Back-to-back inter-packet gap
  ...
  Remarks:
    ...
    in nibble times minus 3.
    In Full-Duplex, the recommended setting is 0x15.

    In Half-Duplex mode, the register value should be the desired period
    in nibble times minus 6.
    In Half-Duplex, the recommended setting is 0x12.
...
/* Function:
  ...
  Returns:
    backToBackIPGValue - Back-to-back inter-packet gap (7-bits)
...
/* Function:
  ...
  Parameters:
    index - Identifier for the device instance
    nonBackToBackIPGValue - Non-back-to-back inter-packet gap
...
/* Function:
  ...
  Returns:
    nonBackToBackIPGValue - Non-back-to-back inter-packet gap (7-bits)
...
/* Function:
  ...
  Returns:
    RMII_100Mbps  - RMII running at 100Mbps
    RMII_10Mbps   - RMII running at 10Mbps
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsPauseTimer( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsEnable( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsStopInIdle( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsTransmitRTS( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsRxEnable( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsAutoFlowControl( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsManualFlowControl( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsRxBufferCountDecrement( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsReceiveBufferSize( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsTxPacketDescriptorAddress( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsRxPacketDescriptorAddress( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsHashTable( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsPatternMatch( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsReceiveFilters( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsReceiveWmarks( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsInterrupt( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsEthernetControllerStatus( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsReceiveOverflowCount( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsFramesTransmittedOK( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsCollisionCounts( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsFramexReceivedOK( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsFCSErrorCount( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsAlignmentErrorCount( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMAC_Resets( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMAC_Configuration( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsInterPacketGaps( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsCollisionWindow( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsRetransmissionMaximum( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMaxFrameLength( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsRMII_Support( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMAC_Testing( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMIIM_Config( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMIIMScanMode( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMIIMReadWrite( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMIIMAddresses( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMIIWriteReadData( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsMIIM_Indicators( ETH_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_ETH_ExistsStationAddress( ETH_MODULE_ID index )
