/*******************************************************************************
  ...
  Summary:
    Defines the Prefetch Cache (PCACHE) Peripheral Library Interface

  Description:
    This header file contains the function prototypes and definitions of
    the data types and constants that make up the interface to the Prefetch
    Cache (PCACHE) Peripheral Library for Microchip microcontrollers. The
...
/*******************************************************************************
  ...
  Returns:
    - true  - cache line is instruction
    - false - cache line is data
...
/*******************************************************************************
  ...
  Returns:
    - true  - cache line is locked
    - false - cache line is unlocked
...
/*******************************************************************************
  ...
  Description:
    This function gets the TAG address in the cache line previously write-
    enabled by PLIB_PCACHE_CacheLineSelect.
  ...
  Returns:
    Address in the cache line TAG register.
...
/*******************************************************************************
  ...
  Returns:
    32-bit unsigned word from cache data array.
...
/*******************************************************************************
  ...
  Summary:
    Reads the state of the cache least recently used encoding bits.

  Description:
    This function reads the state of the cache least recently used encoding
    bits.
  ...
  Returns:
    State of Least Recently Used encoding bits represented as a 25-bit unsigned
    integer.
...
/*******************************************************************************
  ...
  Description:
    This function reads the number of cache hits.
...
/*******************************************************************************
  ...
  Description:
    This function reads the number of cache misses.
...
/*******************************************************************************
  ...
  Description:
    This function reads the number of prefetch aborts.
...
// *****************************************************************************
// *****************************************************************************
// Section: PCACHE Peripheral Library Exists API Routines
// *****************************************************************************
// *****************************************************************************
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsWaitState( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsPrefetchEnable( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsDataCacheEnable( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsFlashSECInt( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsFlashDEDStatus( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsFlashSECStatus( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsFlashSECCount( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsInvalidateOnPFMProgram( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLine( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLineType( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLineLock( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLineValid( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLineAddr( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLineFlashType( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheLineMask( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsWord( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsLeastRecentlyUsedState( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheHit( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsCacheMiss( PCACHE_MODULE_ID index )
...
//******************************************************************************
/* Function :  PLIB_PCACHE_ExistsPrefetchAbort( PCACHE_MODULE_ID index )
