...
<#if CONFIG_USB_DEVICE_FUNCTION_5_DEVICE_CLASS_CDC_IDX0 == true>
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0},   // The first associated interface
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0},                                           // Interface Number
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0},                                                       // com interface number
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0?number+1},
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0?number+1},                                                       // Data interface number

    /* Interrupt Endpoint (IN)Descriptor */

    0x07,                           // Size of this descriptor
    USB_DESCRIPTOR_ENDPOINT,        // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_CDC_INT_ENDPOINT_NUMBER_IDX0}| USB_EP_DIRECTION_IN,      // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_5_CDC_INT_ENDPOINT_NUMBER_IDX0} IN INTERRUPT)
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0?number+1},      // Interface Number
    0x00,                               // Alternate Setting Number
    ...
    0x07,                       // Size of this descriptor
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_CDC_BULK_ENDPOINT_NUMBER_IDX0}|USB_EP_DIRECTION_OUT,     // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_5_CDC_BULK_ENDPOINT_NUMBER_IDX0} OUT)
    ...
    0x07,                       // Size of this descriptor
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_CDC_BULK_ENDPOINT_NUMBER_IDX0}|USB_EP_DIRECTION_IN,      // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_5_CDC_BULK_ENDPOINT_NUMBER_IDX0} IN )
...
<#elseif CONFIG_USB_DEVICE_FUNCTION_5_DEVICE_CLASS_HID_IDX0 == true>
    ...
    USB_DESCRIPTOR_ENDPOINT,        // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_HID_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_IN,      // EndpointAddress
    ...
    0x07,                           // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,        // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_HID_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_OUT,     // EndpointAddress
    USB_TRANSFER_TYPE_INTERRUPT,    // Attributes
    0x40,0x00,                      // size
    0x01,                           // Interval
    ...
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_MSD_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_IN, // EndpointAddress 
    USB_TRANSFER_TYPE_BULK,     // Attributes type of EP (BULK)
    <#if usbDeviceSpeed == 1>
    0x00, 0x02,                 // Max packet size of this EP
    <#elseif usbDeviceSpeed == 2 >
    ...
    7,                          // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_MSD_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_OUT,// EndpointAddress 
    USB_TRANSFER_TYPE_BULK,     // Attributes type of EP (BULK)
    <#if usbDeviceSpeed == 1>
    0x00, 0x02,                 // Max packet size of this EP
    <#elseif usbDeviceSpeed == 2 >
   ...
   ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0},
   ...
   /* USB Speaker Class-specific AC Interface Descriptor  */
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_5_AUDIO_STREAMING_INTERFACES_NUMBER_IDX0},                           /* The number of AudioStreaming interfaces
                                     * in the Audio Interface Collection to which
                                     * this AudioControl interface belongs
                                     * (bInCollection) */

    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0?number + 1},                           /* AudioStreaming interface 1 belongs to this
    ...
    0x09,                            // Size of the descriptor, in bytes (bLength)
    USB_DESCRIPTOR_INTERFACE,        // INTERFACE descriptor type (bDescriptorType)
    ${CONFIG_USB_DEVICE_FUNCTION_5_INTERFACE_NUMBER_IDX0?number + 1},	 // Interface Number  (bInterfaceNumber)
    0x00,                            // Alternate Setting Number (bAlternateSetting)
    0x00,                            // Number of endpoints in this intf (bNumEndpoints)
    ...
    <#elseif CONFIG_USB_DEVICE_FUNCTION_5_DEVICE_CLASS_VENDOR_IDX0 == true>
    /* Interface Descriptor */
    ...
    0x07,                       // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_VENDOR_ENDPOINT_NUMBER_IDX0} |USB_EP_DIRECTION_OUT,   // EndpointAddress
    ...
    0x07,                       // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_5_VENDOR_ENDPOINT_NUMBER_IDX0} |USB_EP_DIRECTION_IN,    // EndpointAddress
    USB_TRANSFER_TYPE_BULK,     // Attributes
    <#if usbDeviceSpeed == 1>
    0x00, 0x02,                 // Max packet size of this EP
    <#elseif usbDeviceSpeed == 2 >
