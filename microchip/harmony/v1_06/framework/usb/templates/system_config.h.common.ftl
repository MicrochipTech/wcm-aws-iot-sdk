...
<#elseif CONFIG_DRV_USB_DEVICE_SUPPORT == true && CONFIG_PIC32MX == true>
/* Enables Device Support */
#define DRV_USBFS_DEVICE_SUPPORT      true
<#elseif CONFIG_DRV_USB_DEVICE_SUPPORT == false && CONFIG_PIC32MZ == true >
/* Disable Device Support */
#define DRV_USBHS_DEVICE_SUPPORT      false
<#elseif CONFIG_DRV_USB_DEVICE_SUPPORT == false && CONFIG_PIC32MX == true>
/* Disable Device Support */
...
<#elseif CONFIG_DRV_USB_HOST_SUPPORT == true && CONFIG_PIC32MX == true>
/* Enables Device Support */
#define DRV_USBFS_HOST_SUPPORT      true
<#elseif CONFIG_DRV_USB_HOST_SUPPORT == false && CONFIG_PIC32MZ == true >
/* Disable Device Support */
#define DRV_USBHS_HOST_SUPPORT      false
<#elseif CONFIG_DRV_USB_HOST_SUPPORT == false && CONFIG_PIC32MX == true>
/* Disable Device Support */
...
<#elseif CONFIG_PIC32MX == true && CONFIG_DRV_USB_DRIVER_MODE == "DYNAMIC">
/* Maximum USB driver instances */
#define DRV_USBFS_INSTANCES_NUMBER    1
<#elseif CONFIG_PIC32MX == true && CONFIG_DRV_USB_DRIVER_MODE == "STATIC">
