...
/* Standard feature selectors.
  ...
  Summary:
    Standard feature selectors as described in Table 9-2 of the USB 2.0 specification.

  Description:
    Standard feature selectors as described in Table 9-2 of USB 2.0 specification.
...
typedef enum
{
    USB_TEST_MODE_SELCTOR_RESERVED          = 0 ,

    USB_TEST_MODE_SELCTOR_TEST_J            = 1 ,

    USB_TEST_MODE_SELCTOR_TEST_K            = 2 ,

    USB_TEST_MODE_SELCTOR_TEST_SE0_NAK      = 3 ,

    USB_TEST_MODE_SELCTOR_TEST_PACKET       = 4 ,

    USB_TEST_MODE_SELCTOR_TEST_FORCE_ENABLE = 5 ,
