...
// *****************************************************************************
/* USB Device Layer Version Macros

  Summary:
    USB Device Layer  version.

  Description:
    These constants provide USB Device Layer  version information. The driver
    version is:
    _USB_DEVICE_VERSION_MAJOR._USB_DEVICE_VERSION_MINOR._USB_DEVICE_VERSION_PATCH.
    It is represented in _USB_DEVICE_VERSION as:
    MAJOR *10000 + MINOR * 100 + PATCH, so as to allow comparisons.
    It is also represented in string format in _USB_DEVICE_VERSION_STR.
    _USB_DEVICE_TYPE provides the type of the release when the release is alpha
    or beta. The interfaces _USB_DEVICE_VersionGet() and
    _USB_DEVICE_VersionStrGet() provide interfaces to the access the version
    and the version string.

  Remarks:
    Modify the return value of _USB_DEVICE_VersionStrGet and the
    _USB_DEVICE_VERSION_MAJOR, _USB_DEVICE_VERSION_MINOR,
    _USB_DEVICE_VERSION_PATCH and _USB_DEVICE_VERSION_TYPE.
*/

#define _USB_DEVICE_VERSION_MAJOR         1
#define _USB_DEVICE_VERSION_MINOR         0
#define _USB_DEVICE_VERSION_PATCH         0
#define _USB_DEVICE_VERSION_TYPE
#define _USB_DEVICE_VERSION_STR           "1.00"
