...
)
{
    ...
    *commandStatus = USB_MSD_CSW_COMMAND_PASSED; 
    ...
    if (msdInstance->mediaDynamicData[logicalUnit].resetSenseData)
    {
        ...
        _USB_DEVICE_MSD_ResetSenseData(&msdInstance-> mediaDynamicData[logicalUnit].gblSenseData);
    }
        ...
        case SCSI_REQUEST_SENSE:
            {
                ...
                _USB_DEVICE_MSD_SendDataToUsb (iMSD, (uint8_t *)&mediaDynamicData->gblSenseData, length);
