...
<#macro DRV_CMP_STATIC_API DRV_INSTANCE>
// *****************************************************************************
// *****************************************************************************
...
void DRV_CMP${DRV_INSTANCE}_Initialize(void);
</#macro>

<#if CONFIG_DRV_CMP_INST_IDX0 == true>
<@DRV_CMP_STATIC_API DRV_INSTANCE="0"/>
</#if>
<#if CONFIG_DRV_CMP_INST_IDX1 == true>
<@DRV_CMP_STATIC_API DRV_INSTANCE="1"/>
</#if>
<#if CONFIG_DRV_CMP_INST_IDX2 == true>
<@DRV_CMP_STATIC_API DRV_INSTANCE="2"/>
</#if>
