 ...
 *******************************************************************************/
 -->
<#macro DRV_TMR_ASM_INT DRV_TMR_INSTANCE DRV_TMR_ID>
...
<@RTOS_ISR VECTOR = TMR_ISR_VECTOR NAME = TMR_ISR_NAME/>
</#macro>

<#if CONFIG_DRV_TMR_INTERRUPT_MODE == true>
<#if CONFIG_DRV_TMR_INST_0 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="0" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX0/>
</#if>
<#if CONFIG_DRV_TMR_INST_1 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="1" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX1/>
</#if>
<#if CONFIG_DRV_TMR_INST_2 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="2" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX2/>
</#if>
<#if CONFIG_DRV_TMR_INST_3 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="3" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX3/>
</#if>
<#if CONFIG_DRV_TMR_INST_4 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="4" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX4/>
</#if>
<#if CONFIG_DRV_TMR_INST_5 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="5" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX5/>
</#if>
<#if CONFIG_DRV_TMR_INST_6 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="6" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX6/>
</#if>
<#if CONFIG_DRV_TMR_INST_7 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="7" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX7/>
</#if>
<#if CONFIG_DRV_TMR_INST_8 == true>
<@DRV_TMR_ASM_INT DRV_TMR_INSTANCE="8" DRV_TMR_ID=CONFIG_DRV_TMR_ISR_VECTOR_IDX8/>
</#if>
</#if>
