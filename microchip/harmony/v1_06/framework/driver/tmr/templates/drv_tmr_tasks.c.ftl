 ...
 *******************************************************************************/
 -->
<#if (CONFIG_USE_DRV_TMR == true) && (CONFIG_DRV_TMR_DRIVER_MODE == "DYNAMIC")>
...
void _DRV_TMR_IDX0_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX0_Tasks(void);
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX1_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX1_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX2_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX2_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX3_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX3_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX4_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX4_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX5_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX5_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX6_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX6_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX7_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX7_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void _DRV_TMR_IDX8_Tasks(ULONG thread_input);
<#else>
void _DRV_TMR_IDX8_Tasks(void);
</#if>
</#if>
</#if>
...
<#if CONFIG_DRV_TMR_INST_0 == true>
    /* Create task for TMR Instance 0 state machine*/
...
<#if CONFIG_DRV_TMR_RTOS_IDX1 == "Standalone">
 <#if CONFIG_DRV_TMR_INST_1 == true>
    /* Create task for TMR Instance 1 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX1_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX2 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_2 == true>
    ...
    /* Create task for TMR Instance 2 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX2_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX3 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_3 == true>
    ...
    /* Create task for TMR Instance 3 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX3_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX4 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_4 == true>
    ...
    /* Create task for TMR Instance 4 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX4_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX5 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_5 == true>
    ...
    /* Create task for TMR Instance 5 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX5_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX6 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_6 == true>
    ...
    /* Create task for TMR Instance 6 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX6_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX7 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_7 == true>
    ...
    /* Create task for TMR Instance 7 state machine*/
...
TASK_STK_SZ=CONFIG_DRV_TMR_IDX7_RTOS_TASK_SIZE/>
 ...
 <#if CONFIG_DRV_TMR_RTOS_IDX8 == "Standalone">
  <#if CONFIG_DRV_TMR_INST_8 == true>
    ...
    /* Create task for TMR Instance 8 state machine*/
