...
void DRV_SPI_SetupDMA( struct DRV_SPI_DRIVER_OBJECT * pDrvInstance)
{
        ...
        switch(pDrvInstance->spiId)
        {
            ...
            break;
#endif
#if (DRV_SPI_NUMBER_OF_MODULES > 1)
            case SPI_ID_2:
            {
            ...
            break;
#endif
#if (DRV_SPI_NUMBER_OF_MODULES > 2)
            case SPI_ID_3:
            {
