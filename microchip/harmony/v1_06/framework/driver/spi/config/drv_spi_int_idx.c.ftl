        ...
        </#if>
{
    ...
    PLIB_INT_SourceFlagClear(INT_ID_0, ${.vars["CONFIG_DRV_SPI_TX_INT_SOURCE_IDX${INST_INDEX}"]});
    PLIB_INT_SourceFlagClear(INT_ID_0, ${.vars["CONFIG_DRV_SPI_RX_INT_SOURCE_IDX${INST_INDEX}"]});
    PLIB_INT_SourceFlagClear(INT_ID_0, ${.vars["CONFIG_DRV_SPI_ERROR_INT_SOURCE_IDX${INST_INDEX}"]});
        </#if>
}
    </#if>
