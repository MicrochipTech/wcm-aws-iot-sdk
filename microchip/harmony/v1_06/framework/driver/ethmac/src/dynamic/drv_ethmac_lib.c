...
void DRV_ETHMAC_LibMACOpen(DRV_ETHMAC_INSTANCE_DCPT* pMacD, TCPIP_ETH_OPEN_FLAGS oFlags, TCPIP_ETH_PAUSE_TYPE pauseType)
{
    ...
    PLIB_ETH_BackToBackIPGSet(index,(oFlags&TCPIP_ETH_OPEN_HDUPLEX)?0x12:0x15);
    ...
    if(oFlags&TCPIP_ETH_OPEN_RMII)
    {
        ...
        PLIB_ETH_RMIISpeedSet(index,(oFlags&TCPIP_ETH_OPEN_100)?ETH_RMII_100Mps:ETH_RMII_10Mbps);
    }
}
