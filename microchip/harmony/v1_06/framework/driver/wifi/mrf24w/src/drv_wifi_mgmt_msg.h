...
/* t_wfParam - Names (ID's) of WF MAC configurable parameters. */
typedef enum
{
    ...
    PARAM_ENABLE_DEBUG_PRINT          = 35,      /* enable WPS debug prints                                     */
    ...
    PARAM_FLASH_update                = 119,     /* auto update                                                 */
    PARAM_FLASH_READ                  = 120,     /* auto update                                                 */
    PARAM_FLASH_WRITE                 = 121      /* auto update                                                 */
#endif
...
#define UPDATE_CMD_CPY_0TO1         0x2         // Copy bank 0 to bank 1
#define UPDATE_CMD_CPY_1TO0         0x3         // Copy bank 1 to bank 0
#define UPDATE_CMD_CPY_CALIBRATION  0x4         // Copy last 128K bytes from bank 1 to bank 0
#define UPDATE_CMD_CMPARE           0x5         // Compare bank 0 and bank 1
#endif
