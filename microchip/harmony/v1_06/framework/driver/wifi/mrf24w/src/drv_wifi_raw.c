...
static const uint16_t g_RawIntMask[NUM_RAW_WINDOWS] = {WF_HOST_INT_MASK_RAW_0_INT_0,   /* used in HOST_INTR reg (8-bit register)   */
...
static t_rawMoveWaitState g_rawMoveWaitState;
volatile tRawMoveState RawMoveState[5];
