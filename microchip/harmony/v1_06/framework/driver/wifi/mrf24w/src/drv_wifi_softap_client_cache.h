...
//typedef enum
//{
//    SOFTAP_CLIENT_CLEAR     = 0,
//    SOFTAP_CLIENT_CONNECTED = 1,
//    SOFTAP_CLIENT_LOST      = 2,
//    SOFTAP_CLIENT_DEAUTH    = 3
//}_DRV_WIFI_SOFTAP_CLIENT_STATES;

typedef struct
{
    //_DRV_WIFI_SOFTAP_CLIENT_STATES status;
    uint8_t mac[6];
