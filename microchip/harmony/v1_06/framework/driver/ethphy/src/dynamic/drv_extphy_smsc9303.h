...
typedef enum
{
	...
	*/
	...
	PHY_REG_ID_REV                      = 0x050,    // Chip ID and Revision Register
        PHY_REG_IRQ_CFG                     = 0x054,    // Interupt Configuration Register
        PHY_REG_INT_STS                     = 0x058,    // Interupt Status Register
        PHY_REG_INT_EN                      = 0x05C,    // Interupt Enable Register
        PHY_REG_BYTE_TEST                   = 0x064,    // Byte Order Test Register
        PHY_REG_HW_CFG                      = 0x068,    // Hardware Configuration Register
        PHY_REG_GPT_CFG                     = 0x08C,    // General Pupose Timer Configuration Register
