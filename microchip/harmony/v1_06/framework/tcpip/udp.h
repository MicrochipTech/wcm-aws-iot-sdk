...
typedef enum
{
    ...
    TCPIP_UDP_SIGNAL_TX_DONE  = 0x0001,  // A data packet was successfully transmitted on the interface
                                        ...
                                        //  - since UDP transmissions are triggerred by an explicit call to TCPIP_UDP_Flush,
...
/*
  Function:
	uint16_t TCPIP_UDP_ArrayPutRaw(UDP_SOCKET hUDP, const uint8_t *cData, uint16_t wDataLen)
...
/*
  ...
  */
uint16_t            TCPIP_UDP_ArrayGetRaw(UDP_SOCKET hUDP, uint8_t *cData, uint16_t wDataLen);
...
/*
  ...
  Remarks:
    ...
    See notes above for TCPIP_UDP_ArrayGet function.
 */
uint16_t                TCPIP_UDP_Get(UDP_SOCKET hUDP, uint8_t *v);
...
/*
  ...
  Description:
      - It sets the destination port
        This allows changing the destination port dynamically.
...
// *****************************************************************************
/* Function:
    TCPIP_UDP_SignalHandlerRegister(UDP_SOCKET s, TCPIP_UDP_SIGNAL_TYPE sigMask, TCPIP_UDP_SIGNAL_FUNCTION handler, const void* hParam)
...
/*
  ...
  Description:
    Performs UDP module tasks in the TCP/IP stack.

  Precondition:
    UDP module should have been initialized
