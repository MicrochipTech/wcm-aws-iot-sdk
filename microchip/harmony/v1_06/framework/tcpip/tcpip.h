/*******************************************************************************
  ...
  It contains the basic TCP/IP types and data structuresa and includes all the TCP/IP stack modules.
...
#define TCPIP_STACK_VERSION_MINOR         24
#define TCPIP_STACK_VERSION_PATCH         0
#define TCPIP_STACK_VERSION_STR           "7.24"
