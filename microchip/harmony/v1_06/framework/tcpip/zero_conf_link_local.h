...
/***************************************************************
  ...
  Summary:
 Enables zero config on the specified interface.
...
/***************************************************************
  ...
  Summary:
 Disables zero config on the specified interface.
...
/*
  ...
  Description:
    Performs ZCLL module tasks in the TCP/IP stack.

  Precondition:
    ZCLL module should have been initialized
