...
/*  MAC Modules ID
  ...
  Summary:
    IDs of the MAC module ssupported by the stack.
...
typedef struct _tag_MAC_DATA_SEGMENT
{
    ...
    /*  TCPIP_MAC_SEGMENT_FLAGS segment flags:
        TCPIP_MAC_SEG_FLAG_STATIC, TCPIP_MAC_SEG_FLAG_RX, TCPIP_MAC_SEG_FLAG_RX, TCPIP_MAC_SEG_FLAG_RX_STICKY */
    uint16_t                 segFlags;       
...
*/
typedef void*   (*TCPIP_MAC_HEAP_MallocF)(TCPIP_MAC_HEAP_HANDLE heapH, size_t nBytes);
typedef void*   (*TCPIP_MAC_HEAP_MallocFDbg)(TCPIP_MAC_HEAP_HANDLE heapH, size_t nBytes, int moduleId, int lineNo);
...
*/
typedef int     (*TCPIP_MAC_HEAP_FreeF)(TCPIP_MAC_HEAP_HANDLE heapH, const void* pBuff);
typedef int     (*TCPIP_MAC_HEAP_FreeFDbg)(TCPIP_MAC_HEAP_HANDLE heapH, const void* pBuff, int moduleId, int lineNo);
...
/*  
  ...
  Parameters:
    - object - Driver object handle, returned from the TCPIP_MAC_Initialize
               routine
...
/*  Function:
  ...
  Parameters:
    ...
    - pHwEntries    - pointer to an address to store the number of the statistics registers that the hardware suports
