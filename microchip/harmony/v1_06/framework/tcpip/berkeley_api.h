...
/******************************************************************************
  ...
  Parameters:
    - s - Socket descriptor returned from a previous call to socket
    - level           - What level the operation is to be done on
    ...
    - option_name     - The name of the option to be set
        IPPROTO_TCP
            TCP_NODELAY -- specifies whether or not the stack should use the Nagle algorithm or not
        SOL_SOCKET
...
/******************************************************************************
 ...
 Remarks:
    ...
    or connect (client sockets).
    Please note that calling the TCPIP_BSD_Socket before one of these calls will return an INVALID_SOCKET.
...
/******************************************************************************
 ...
 This function deprecates gethostbyname.  It handles both IPv4 and IPv6.
  ...
  Precondition:
 Harmony DNS client services must be active.
