...
/*
  ...
  Summary:
    ICMPv6 Packet Echo Request info code
...
/*
  ...
  Summary:
    ICMPv6 Packet Echo Reply info code
...
/*
  ...
  Description:
	Allocates a packet using TCPIP_ICMPV6_Open() and updates local and remote addresses.
...
/*
  ...
  Description:
	Transmit out ICMPv6 packet to outside.	
...
/*
  ...
  Description:
	Deregisters a previously registered function from the ICMPv6 register list.     
