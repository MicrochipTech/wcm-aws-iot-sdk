...
/*****************************************************************************
  ...
  Internal:
    TCPIP_SMTP_Put must be used instead of TCPIP_TCP_ArrayPut because "rn." must be
    transparently replaced by "rn..".
 */
uint16_t TCPIP_SMTP_ArrayPut(uint8_t* Data, uint16_t Len);
...
/*****************************************************************************
  ...
  Internal:
    TCPIP_SMTP_Put must be used instead of TCPIP_TCP_StringPut because "rn." must be
    transparently replaced by "rn..".
 */
uint16_t TCPIP_SMTP_StringPut(char* Data);
...
/*
  ...
  Description:
    Performs SMTP module tasks in the TCP/IP stack.
