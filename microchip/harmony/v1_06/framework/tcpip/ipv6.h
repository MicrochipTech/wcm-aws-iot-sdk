...
/* 
  ...
  Summary:
    Data structure for IPv6 addresses types.
...
/* 
  ...
  Description:
	Policy table is the longest matching prefix lookup table. Policy Table is 
...
/* 
  ...
  Remarks:
    Any extension header present are considered part of payload length.
 */
typedef struct
{
...
/*
  ...
  Description:
    Ipv6 policy table is used to select the Destination address. Destination Address selection algorithm 
	takes a list of IPv6 addresses (gPolicyTable). Sort the linked list.
...
/*
  ...
  Description:
    Dynamically allocates a packet for transmitting IP protocol data and 
...
/*
  ...
  Description:
    ...
    allocate additional space to the packet to accommodate the user.
...
/*
  ...
  Description:
    This APi is used to read a byte data from a packet.
...
/*
  ...
  Description:
    This API is used to get the destination address for an IPv6 packet.
...
/*
  ...
  Description:
    This API is used to configure the source address for an IPv6 packet.
...
/*
  ...
  Parameters:
    ...
    prefixLen       - The prefix length associated to this static address
                      (giving the subnet prefix length)
                      if 0, the default value of 64 will be used
...
*/
IPV6_ADDR_STRUCT * TCPIP_IPV6_UnicastAddressAdd(TCPIP_NET_HANDLE netH, IPV6_ADDR * address, int prefixLen, uint8_t skipProcessing);
...
/*
  ...
  Description:
    This API is used to remove a configured unicast address from an interface.
...
/*
  ...
  Description:
    This API is used to add the IPv6 multicast address to an interface.
...
/*
  ...
  Input:
    ...
    genFlags -    Address generation flags:
                  * IPV6_ULA_FLAG_NTPV4
                    * if set, the ntpAddress is an IPv4 address and the NTP
                      server will be contacted over an IPv4 connection
                    * otherwise, a default IPv6 connection will be attempted
                  * IPV6_ULA_FLAG_GENERATE_ONLY
                    * if set, the address will not be added to the list of
                      the addresses for the specified interface
                  * IPV6_ULA_FLAG_SKIP_DAD
                    * if set, the DAD processing will be skipped
    ntpAddress -  The NTP server address - it's an IPv4/IPv6 address as
...
/*
  ...
  Description:
    Adds a unicast address as a routing address to a specified interface.
...
/*
  ...
  Description:
    Deletes all default routers on a given interface
...
/*
  ...
  Description:
    This API is used to register a notification handler with the IPv6 module.
...
/*
  ...
  Description:
    Deregisters a previously registered IPv6 event handler callback function.
...
/*
  ...
  Description:
    Performs IPv6 module tasks in the TCP/IP stack.

  Precondition:
    IPV6 module should have been initialized
