...
/*
  ...
  Description:
    This structure is used to configure Communty details during runtime.
...
/*
  ...
  Description:
    This structure is used to configure pre defined SNMPv3  USM details
...
typedef struct
{
    ...
    char* snmp_bib_file;
    TCPIP_SNMP_COMMUNITY_CONFIG *read_community_config; /* readonly Community configuration*/
    TCPIP_SNMP_COMMUNITY_CONFIG *write_community_config; /* writeonly Community configuration*/
    TCPIP_SNMPV3_USM_USER_CONFIG *usm_config; /* SNMPv3 USM coniguration*/
