...
/* Function:
  ...
  Precondition:
    TCPIP Stack initialized, up and running.
  ...
  Returns:
    - ICMP_ECHO_OK    - if the query request was successfully sent
    - an ICMP_ECHO_RESULT error code otherwise
...
/* Function:
  ...
  <code>
    ...
    // success; I can send an Echo request an receive notification
...
/* Function:
  ...
  Summary:
    De-registers the ICMP callback function.

  Description:
    This function a stack client to remove its former registered notification handler.
  ...
  Returns:
    ...
    false - if such notification handler couldn't be found
...
/*
  ...
  Description:
    Performs ICMPv4 module tasks in the TCP/IP stack.

  Precondition:
    ICMP module should have been initialized
