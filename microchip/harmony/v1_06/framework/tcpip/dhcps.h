...
/******************************************************************************
 Function:
  ...
  Description:
    This API is used to remove one entry from the leased HASH table with respect to the
    interface and the MAC address.
  ...
  Remarks:
     This API is called from command line to remove one entry and from the WiFI driver module
     to remove a node which is disconnected from the AP.
  ***************************************************************************/
bool TCPIP_DHCPS_LeaseEntryRemove(TCPIP_NET_HANDLE netH, TCPIP_MAC_ADDR* hwAdd);
...
/*
  ...
  Description:
    Performs DHCP server module tasks in the TCP/IP stack.
