...
static const TCPIP_SNTP_MODULE_CONFIG sntpConfigDefault = 
{
    TCPIP_NTP_SERVER,                 // ntp_server
    TCPIP_NTP_DEFAULT_IF,             // ntp_interface
    TCPIP_NTP_DEFAULT_CONNECTION_TYPE,// ntp_connection_type
    TCPIP_NTP_REPLY_TIMEOUT,          // ntp_reply_timeout
    TCPIP_NTP_TIME_STAMP_TMO,         // ntp_stamp_timeout
    TCPIP_NTP_QUERY_INTERVAL,         // ntp_success_interval
    TCPIP_NTP_FAST_QUERY_INTERVAL,    // ntp_error_interval
};
...
static void TCPIP_SNTP_Process(void)
{
    ...
    switch(sntpState)
    {
        ...
        case SM_HOME:
            ...
            TCPIP_DNS_Resolve(sntpServerName, ntpConnection == IP_ADDRESS_TYPE_IPV6 ? DNS_TYPE_AAAA : DNS_TYPE_A);
            sntpState = SM_WAIT_DNS;
            break;

        case SM_WAIT_DNS:
            dnsRes = TCPIP_DNS_IsResolved(sntpServerName, &ntpServerIP);
