...
TCPIP_SNMP_COMMUNITY_CONFIG snmp_default_readcomm_config[] =
{
    {
        "public",
    },
...
TCPIP_SNMP_COMMUNITY_CONFIG snmp_default_writecomm_config[] =
{
    {
        "private",
    },
...
TCPIP_SNMPV3_USM_USER_CONFIG usm_default_config[] =
 {
    {
        "microchip",            /* securityName */
        AUTH_PRIV,              /* authentication and privacy security-level */
        /* auth */
        SNMPV3_HMAC_MD5,        /* MD5 auth protocol */
        "auth12345",            /* auth passphrase */
        /* priv */
        SNMPV3_AES_PRIV,        /* AES priv protocol */
        "priv12345",            /* priv passphrase */
    },
    {
        "SnmpAdmin",            /* securityName */
        AUTH_NO_PRIV,           /* Only authentication security-level */
        /* auth */
        SNMPV3_HMAC_SHA1,        /* SHA auth protocol */
        "ChandlerUS",            /* auth passphrase */
        /* priv */
        SNMPV3_NO_PRIV,         /* AES priv protocol */
        "",                     /* priv passphrase */
    },
    {
        "root",            /* securityName */
        NO_AUTH_NO_PRIV,           /* No authentication and no privacy security-level */
        /* auth */
        SNMPV3_NO_HMAC_AUTH,        /* SHA auth protocol */
        "",            /* auth passphrase */
        /* priv */
        SNMPV3_NO_PRIV,         /* AES priv protocol */
        "",                     /* priv passphrase */
...
TCPIP_SNMPV3_TARGET_ENTRY_CONFIG target_default_trap_config[]=
{
    {
        "microchip",                    /* securityName */
        SNMPV3_MSG_PROCESSING_MODEL,    /* Message processing model */
        SNMPV3_USM_SECURITY_MODEL,      /* MD5 auth protocol */
        AUTH_PRIV,             /* authentication and privacy security-level */
    },
    {
        "SnmpAdmin",                    /* securityName */
        SNMPV3_MSG_PROCESSING_MODEL,    /* Message processing model */
        SNMPV3_USM_SECURITY_MODEL,      /* MD5 auth protocol */
        AUTH_NO_PRIV,             /* authentication and No privacy security-level */
    },
    {
        "root",                    /* securityName */
        SNMPV3_MSG_PROCESSING_MODEL,    /* Message processing model */
        SNMPV3_USM_SECURITY_MODEL,      /* MD5 auth protocol */
        NO_AUTH_NO_PRIV,             /* authentication and No privacy security-level */
    },
};
#endif
const TCPIP_SNMP_MODULE_CONFIG snmpDefaultConfigData =
{
    true,
    true,
    true, // it is true , as version is SNMP_V3. For other version it will be false.
    TCPIP_SNMP_BIB_FILE_NAME,
    (TCPIP_SNMP_COMMUNITY_CONFIG*)snmp_default_readcomm_config,
    (TCPIP_SNMP_COMMUNITY_CONFIG*)snmp_default_writecomm_config,
#ifdef TCPIP_STACK_USE_SNMPV3_SERVER
    (TCPIP_SNMPV3_USM_USER_CONFIG*)usm_default_config,
...
{	
    ...
    { 
        if(snmpData == NULL)
        {
            snmpData = &snmpDefaultConfigData;
        }
