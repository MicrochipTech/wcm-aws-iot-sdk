...
/* DMA System Service Invalid Channel Handle
  ...
  Summary:
    Definition of an invalid channel handle.
...
/* Function:
  ...
  Remarks:
    ...
    RAM memory adresses then the the source/destination buffers
    should be made coherent to avoid the cache coherency issues.

    Example:
    uint32_t buffer[1024];
    The above buffer can be made coherent by adding the 'coherent' attribute
    as shown below
    uint32_t __attribute__((coherent)) buffer[1024];
*/
