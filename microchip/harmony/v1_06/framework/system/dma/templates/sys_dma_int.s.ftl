 ...
 *******************************************************************************/
 -->
<#macro SYS_DMA_ASM_INT DMA_INSTANCE DMA_CHANNEL>
...
<@RTOS_ISR VECTOR = DMA_ISR_VECTOR NAME = DMA_ISR_NAME/>
</#macro>

<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH0 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="0" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX0/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH1 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="1" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX1/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH2 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="2" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX2/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH3 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="3" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX3/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH4 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="4" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX4/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH5 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="5" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX5/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH6 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="6" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX6/>
</#if>
<#if CONFIG_SYS_DMA_INTERRUPT_MODE_CH7 == true>
<@SYS_DMA_ASM_INT DMA_INSTANCE="7" DMA_CHANNEL=CONFIG_SYS_DMA_CHANNEL_ID_IDX7/>
</#if>
