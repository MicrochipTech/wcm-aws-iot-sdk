...
<#macro SYS_INT_ASM_INT SYS_INT_INSTANCE SYS_INT_ID>
...
<@RTOS_ISR VECTOR = EXT_INT_ISR_VECTOR NAME = EXT_INT_ISR_NAME/>
</#macro>
<#if CONFIG_EXT_INT_INST_IDX0 == true>
<@SYS_INT_ASM_INT SYS_INT_INSTANCE="0" SYS_INT_ID=CONFIG_EXT_INT_PERIPHERAL_ID_IDX0/>
</#if>
<#if CONFIG_EXT_INT_INST_IDX1 == true>
<@SYS_INT_ASM_INT SYS_INT_INSTANCE="1" SYS_INT_ID=CONFIG_EXT_INT_PERIPHERAL_ID_IDX1/>
</#if>
<#if CONFIG_EXT_INT_INST_IDX2 == true>
<@SYS_INT_ASM_INT SYS_INT_INSTANCE="2" SYS_INT_ID=CONFIG_EXT_INT_PERIPHERAL_ID_IDX2/>
</#if>
<#if CONFIG_EXT_INT_INST_IDX3 == true>
<@SYS_INT_ASM_INT SYS_INT_INSTANCE="3" SYS_INT_ID=CONFIG_EXT_INT_PERIPHERAL_ID_IDX3/>
</#if>
<#if CONFIG_EXT_INT_INST_IDX4 == true>
<@SYS_INT_ASM_INT SYS_INT_INSTANCE="4" SYS_INT_ID=CONFIG_EXT_INT_PERIPHERAL_ID_IDX4/>
</#if>
