...
/* SYS CMD Processor Maximum Number of Command Group
  ...
  Description:
    This defines the maximum number of command groups.
...
/* SYS CMD Processor Maximum Number of Command Arguments
  ...
  Description:
    This defines the maximum number of arguments per command.
...
/************************************************************************
  ...
  Description:
    Single Character Print function API
...
/************************************************************************
  ...
  Description:
    Ready Status Check function API
...
/************************************************************************
  ...
  Description:
    Get Single Character function API
...
/* Function:
  ...
  Summary:
     Get the CMDIO Handle base via index
  ...
  Returns:
    If successful, the SYS_CMD_DEVICE_NODE Handle for the CMDIO
...
/* Function:
  ...
  Summary:
    Adds CMDIO Parameters the Command Processor System Service console.
...
/* Function:
  ...
  Summary:
    Removes CMDIO Parameters the Command Processor System Service console.
