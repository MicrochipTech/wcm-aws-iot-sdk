...
#ifndef _SYS_RESET_MAPPING_H
#define _SYS_RESET_MAPPING_H
...
*/
    ...
    #define _SYS_RESET_PART_SPECIFIC   __attribute__((unsupported("The microcontroller selected does not implement this feature.")))
#endif
#ifndef _SYS_RESET_PART_SPECIFIC
    #define _SYS_RESET_PART_SPECIFIC
#endif

#endif //_SYS_RESET_MAPPING_H
