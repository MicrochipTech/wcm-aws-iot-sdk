...
struct QPkt wrQElements[SYS_CONSOLE_USB_CDC_WR_QUEUE_DEPTH];
struct QPkt rdQElements[SYS_CONSOLE_USB_CDC_RD_QUEUE_DEPTH];

struct Queue wrQueue = {0, 0, 0, wrQElements, SYS_CONSOLE_USB_CDC_WR_QUEUE_DEPTH};
struct Queue rdQueue = {0, 0, 0, rdQElements, SYS_CONSOLE_USB_CDC_RD_QUEUE_DEPTH};
