...
<#if CONFIG_SYS_CONSOLE_SOURCE_IDX1 == "APPIO_CONSOLE">
    sysObj.sysConsole1 = SYS_CONSOLE_Initialize(SYS_CONSOLE_INDEX_0, (SYS_MODULE_INIT *)&consAppIOInit1);
</#if>
<#if CONFIG_SYS_CONSOLE_SOURCE_IDX1 == "UART_CONSOLE">
    sysObj.sysConsole1 = SYS_CONSOLE_Initialize(SYS_CONSOLE_INDEX_0, (SYS_MODULE_INIT *)&consUsartInit1);
</#if>
<#if CONFIG_SYS_CONSOLE_SOURCE_IDX1 == "USB_CDC_CONSOLE">
    sysObj.sysConsole1 = SYS_CONSOLE_Initialize(SYS_CONSOLE_INDEX_0, (SYS_MODULE_INIT *)&consUsbInit1);
</#if></#if></#if>
