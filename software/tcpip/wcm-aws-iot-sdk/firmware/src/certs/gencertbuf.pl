...
my @fileList_2048 = (
        [ "./clientKey.der", "clientKey_der_2048" ],
        [ "./clientCert.der", "clientCert_der_2048" ], 
        [ "./rootCA.der", "rootCA_der_2048" ]
        );
...
print OUT_FILE "/* certs.h */\n\n";
print OUT_FILE "#ifndef CERTS_H\n";
print OUT_FILE "#define CERTS_H\n\n";
